...
class Surge
{
    ...
    public function handle()
    {
        ...
        // Subscription link
        $surgeSub = request()->header('surge-sub');
        $subsDomain = request()->header('Host');

        $subsURL = $surgeSub ?: Helper::getSubscribeUrl($user['token'], $subsDomain ? 'https://' . $subsDomain : null);
        ...
        return response($config, 200)
                    ->header('content-disposition', "attachment;filename=".rawurlencode($appName).".conf");
    }
